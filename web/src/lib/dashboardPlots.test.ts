...
describe("buildSleepWindowChartStats", () => {
  it("maps overnight sleep windows and computes averages", () => {
    const stats = buildSleepWindowChartStats([
      { date: "2026-02-01", fellAsleepAt: "23:00", wokeUpAt: "07:00" },
      { date: "2026-02-02", fellAsleepAt: "22:30", wokeUpAt: "06:30" },
    ]);
  ...
  it("excludes missing records from averages", () => {
    const stats = buildSleepWindowChartStats([
      { date: "2026-02-01", fellAsleepAt: "23:30", wokeUpAt: "07:10" },
      { date: "2026-02-02", fellAsleepAt: null, wokeUpAt: "06:30" },
    ]);
