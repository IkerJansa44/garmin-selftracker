...
FEATURE_LABELS = {
    ...
    "garmin:strongestAerobicTrainingEffect": "Strongest Aerobic Training Effect",
    "garmin:strongestAerobicToSleepGapMinutes": "Strongest Aerobic Session to Sleep (min)",
    "garmin:strongestAnaerobicTrainingEffect": "Strongest Anaerobic Training Effect",
    "garmin:strongestAnaerobicToSleepGapMinutes": "Strongest Anaerobic Session to Sleep (min)",
